                                ...
                                <div class="modal-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item" data-value="1" data-name="WISP">
                                            1. WISP <br>
                                            <strong>Dirección:</strong> Calle Falsa <br>
                                            <strong>Referencia: </strong> Cerca del Parque Central 
                                        </li>
                                        ...
                                        <li class="list-group-item" data-value="4" data-name="GPON Y CABLE">
                                            4. GPON Y CABLE <br>
                                            <strong>Dirección:</strong> Calle Falsa <br>
                                            <strong>Referencia: </strong> Cerca del Parque Central 
                                        </li>

                                        <li class="list-group-item" data-value="5" data-name="WISP Y CABLE">
                                            5. WISP Y CABLE <br>
                                            <strong>Dirección:</strong> Calle Falsa <br>
                                            <strong>Referencia: </strong> Cerca del Parque Central 
                                        </li>
