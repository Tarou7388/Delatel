            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <ul class="list-group">
                    <li class="list-group-item" data-value="1" data-name="WISP">WISP</li>
                    <li class="list-group-item" data-value="2" data-name="GPON">GPON</li>
                    <li class="list-group-item" data-value="3" data-name="CABLE">CABLE</li>
                  </ul>
                </div>
