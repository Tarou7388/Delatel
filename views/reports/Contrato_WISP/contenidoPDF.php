...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
  ...
  <tbody>
    <tr>
      ...
      <td style="vertical-align: top; padding-right: 5px;">
        <table>
          ...
          <tbody>
            <tr>
              <td><img src="<?= $HOST; ?>image/Logo_compuIvan.jpg" class="logo" alt="Logo"></td>
              <td>
                <h3 style="margin: 2px 0; flex-grow: 1;">CONTRATO DE PRESTACIÓN DEL SERVICIO DE ACCESO A INTERNET FIJO</h3>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <tr>
      <td style="vertical-align: top; padding-right: 5px;">
        <h4><img src="<?= $HOST; ?>image/iconoHerramienta.svg" class="icono" alt=""> 6) INSTALACIÓN DEL SERVICIO</h4>
        ...
        <h4><img src="<?= $HOST; ?>image/iconoBoleta.svg" class="icono" alt=""> 7) RECIBO Y PAGO DEL SERVICIO</h4>
        ...
        <h4><img src="<?= $HOST; ?>image/iconoExclamacion.svg" class="icono" alt=""> 8) DERECHOS Y OBLIGACIONES</h4>
      ...
      <td style="vertical-align: top; padding-left: 5px;">
        ...
        <h4><img src="<?= $HOST; ?>image/iconoRegistro.svg" class="icono" alt=""> 9) MODIFICACIÓN DEL CONTRATO</h4>
        ...
        <h4><img src="<?= $HOST; ?>image/iconoDislike.svg" class="icono" alt=""> 10) BAJA DE TU SERVICIO</h4>
    ...
    <tr>
      <td style="vertical-align: top; padding-left: 5px;">
        <h4><img src="<?= $HOST; ?>image/iconoUsuario.svg" class="icono" alt=""> 12) USO DE TUS DATOS PERSONALES</h4>
        ...
        <h4><img src="<?= $HOST; ?>image/iconoCheck.svg" class="icono" alt=""> 13) ACEPTACIÓN DEL CONTRATO</h4>
        <p>
