...
('{"id_servicio": [1]}', 'Internet Residencial Básico', '100.00', 1),
('{"id_servicio": [3]}', 'Internet Fibra Avanzado', '150.00', 1),
...
('{"id_servicio": [2]}', 'Paquete Doble: Internet + Televisión WISP', '120.00', 1),
('{"id_servicio": [2]}', 'Paquete Triple: Internet + Televisión + Telefonía WISP', '180.00', 1),
('{"id_servicio": [3]}', 'Internet Móvil Prepago Fibra', '20.00', 1),
('{"id_servicio": [2]}', 'VPN para Empresas WISP', '80.00', 1),
('{"id_servicio": [1]}', 'Hosting Web para Empresas Cable', '60.00', 1),
('{"id_servicio": [3]}', 'Correo Electrónico Empresarial Fibra', '40.00',  1),
('{"id_servicio": [2]}', 'Dominios Web WISP', '10.00', 1),
('{"id_servicio": [2]}', 'Servicio de Soporte Técnico WISP', '50.00', 1),
...
('{"id_servicio": [3]}', 'Monitoreo de Red para Empresas Fibra', '120.00', 1),
('{"id_servicio": [2]}', 'Análisis de Conectividad WISP', '80.00', 1),
('{"id_servicio": [1]}', 'Instalación de CCTV para Seguridad Cable', '150.00', 1),
...
('{"id_servicio": [3, 1]}', 'Plataforma de E-learning para Empresas Fibra', '400.00', 1),
('{"id_servicio": [1]}', 'Internet Residencial Básico', '100.00', 1),
('{"id_servicio": [3]}', 'Internet Fibra Avanzado', '150.00', 1),
('{"id_servicio": [2]}', 'Internet Empresarial WISP', '200.00', 1),
('{"id_servicio": [2]}', 'Televisión por Cable WISP', '50.00', 1),
...
('{"id_servicio": [3]}', 'Correo Electrónico Empresarial Fibra', '40.00', 1),
('{"id_servicio": [2]}', 'Dominios Web WISP', '10.00', 1),
('{"id_servicio": [2]}', 'Servicio de Soporte Técnico WISP', '100.00', 1),
