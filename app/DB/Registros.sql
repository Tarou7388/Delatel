...
INSERT INTO tb_servicios (tipo_servicio, servicio, iduser_create) VALUES
  ...
  ('GPON','Gigabit-capable Passive Optical Network', 1),
  ('FIBR','Fibra Óptica', 1);

INSERT INTO tb_paquetes (id_servicio, paquete, precio, duracion, iduser_create) VALUES
(1, 'Internet Residencial Básico', '100.00', '{"duracion": 12}', 1),
(3, 'Internet Residencial Avanzado', '150.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Internet Empresarial', '200.00', '{"duracion": 12}', 1),
(4, 'Televisión por Cable', '50.00', '{"duracion": 12}', 1),
(3, 'Telefonía Fija', '30.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Paquete Doble: Internet + Televisión', '120.00', '{"duracion": 12}', 1),
(4, 'Paquete Triple: Internet + Televisión + Telefonía', '180.00', '{"duracion": 12}', 1),
(3, 'Internet Móvil Prepago', '20.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'VPN para Empresas', '80.00', '{"duracion": 12}', 1),
(1, 'Hosting Web para Empresas', '60.00', '{"duracion": 12}', 1),
(3, 'Correo Electrónico Empresarial', '40.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Dominios Web', '10.00', '{"duracion": 12}', 1),
(4, 'Servicio de Soporte Técnico', '100.00', '{"duracion": 12}', 1),
(3, 'Mantenimiento de Equipos de Red', '70.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Instalación de Equipos de Internet', '90.00', '{"duracion": 12}', 1),
(1, 'Configuración de Router y Modem', '50.00', '{"duracion": 12}', 1),
(3, 'Internet para Eventos Especiales', '200.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Plan de Seguridad en Línea', '150.00', '{"duracion": 12}', 1),
(1, 'Backup en la Nube', '70.00', '{"duracion": 12}', 1),
(3, 'Monitoreo de Red para Empresas', '120.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Análisis de Conectividad', '80.00', '{"duracion": 12}', 1),
(1, 'Instalación de CCTV para Seguridad', '150.00', '{"duracion": 12}', 1),
(3, 'Teleasistencia Técnica', '60.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Acceso a Wi-Fi Público', '30.00', '{"duracion": 12}', 1),
(1, 'Streaming de Video HD', '20.00', '{"duracion": 12}', 1),
(3, 'Streaming de Música', '15.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Capacitación en Tecnología Digital', '100.00', '{"duracion": 12}', 1),
(1, 'Gestión de Redes Sociales', '200.00', '{"duracion": 12}', 1),
(3, 'Publicidad en Línea', '300.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Soporte 24/7 para Clientes', '250.00', '{"duracion": 12}', 1),
(1, 'Desarrollo de Aplicaciones Web', '500.00', '{"duracion": 12}', 1),
(3, 'Plataforma de E-learning para Empresas', '400.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Gestión de Proyectos TI', '350.00', '{"duracion": 12}', 1),
(1, 'Servicios de Cloud Computing', '300.00', '{"duracion": 12}', 1),
(1, 'Asesoría en Tecnología de la Información', '150.00', '{"duracion": 12}', 1),
(2, 'Instalación de Redes Inalámbricas', '200.00', '{"duracion": 12}', 1),
(1, 'Consultoría de Seguridad Informática', '250.00', '{"duracion": 12}', 1),
(3, 'Soluciones de Internet de las Cosas (IoT)', '300.00', '{"fibra": 24, "cable": 12}', 1),
(2, 'Acceso a Contenido Premium', '100.00', '{"duracion": 12}', 1),
(4, 'Migración a la Nube', '400.00', '{"duracion": 12}', 1),
(3, 'Desarrollo de Sistemas de Gestión', '500.00', '{"fibra": 24, "cable": 12}', 1);
