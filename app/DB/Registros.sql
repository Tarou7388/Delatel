...
INSERT INTO tb_paquetes (id_servicio, id_servicio2, paquete, precio, duracion, iduser_create) VALUES
(1, NULL, 'Internet Residencial Básico', '100.00', '{"CABL": 7}', 1),
(3, NULL, 'Internet Fibra Avanzado', '150.00', '{"FIBR": 10}', 1),
(2, NULL, 'Internet Empresarial WISP', '200.00', '{"WISP": 10}', 1),
(2, NULL, 'Televisión por Cable WISP', '50.00', '{"WISP": 10}', 1),
(3, NULL, 'Telefonía Fija Fibra', '30.00', '{"FIBR": 10}', 1),
(2, NULL, 'Paquete Doble: Internet + Televisión WISP', '120.00', '{"WISP": 10}', 1),
(2, NULL, 'Paquete Triple: Internet + Televisión + Telefonía WISP', '180.00', '{"WISP": 10}', 1),
(3, NULL, 'Internet Móvil Prepago Fibra', '20.00', '{"FIBR": 10}', 1),
(2, NULL, 'VPN para Empresas WISP', '80.00', '{"WISP": 10}', 1),
(1, NULL, 'Hosting Web para Empresas Cable', '60.00', '{"CABL": 3}', 1),
(3, NULL, 'Correo Electrónico Empresarial Fibra', '40.00', '{"FIBR": 10}', 1),
(2, NULL, 'Dominios Web WISP', '10.00', '{"WISP": 10}', 1),
(2, NULL, 'Servicio de Soporte Técnico WISP', '100.00', '{"WISP": 10}', 1),
(3, NULL, 'Mantenimiento de Equipos de Red Fibra', '70.00', '{"FIBR": 10}', 1),
(2, NULL, 'Instalación de Equipos de Internet WISP', '90.00', '{"WISP": 10}', 1),
(1, NULL, 'Configuración de Router y Modem Cable', '50.00', '{"CABL": 8}', 1),
(3, NULL, 'Internet para Eventos Especiales Fibra', '200.00', '{"FIBR": 10}', 1),
(2, NULL, 'Plan de Seguridad en Línea WISP', '150.00', '{"WISP": 10}', 1),
(1, NULL, 'Backup en la Nube Cable', '70.00', '{"CABL": 5}', 1),
(3, NULL, 'Monitoreo de Red para Empresas Fibra', '120.00', '{"FIBR": 10}', 1),
(2, NULL, 'Análisis de Conectividad WISP', '80.00', '{"WISP": 10}', 1),
(1, NULL, 'Instalación de CCTV para Seguridad Cable', '150.00', '{"CABL": 6}', 1),
(3, NULL, 'Teleasistencia Técnica Fibra', '60.00', '{"FIBR": 10}', 1),
(2, NULL, 'Acceso a Wi-Fi Público WISP', '30.00', '{"WISP": 10}', 1),
(1, 3, 'Streaming de Video HD', '20.00', '{"CABL": 4, "FIBR": 10}', 1),
(3, NULL, 'Streaming de Música Fibra', '15.00', '{"FIBR": 10}', 1),
(2, NULL, 'Capacitación en Tecnología Digital WISP', '100.00', '{"WISP": 10}', 1),
(1, 3, 'Gestión de Redes Sociales', '200.00', '{"CABL": 4, "FIBR": 10}', 1),
(3, 1, 'Publicidad en Línea Fibra', '300.00', '{"FIBR": 24, "CABL": 12}', 1),
(1, 3, 'Soporte 24/7 para Clientes WISP', '250.00', '{"CABL": 4, "FIBR": 10}', 1),
(1, 3, 'Desarrollo de Aplicaciones Web', '500.00', '{"CABL": 4, "FIBR": 10}', 1),
(3, 1, 'Plataforma de E-learning para Empresas Fibra', '400.00', '{"FIBR": 24, "CABL": 12}', 1),
(1, 3, 'Gestión de Proyectos TI WISP', '350.00', '{"CABL": 4, "FIBR": 10}', 1),
(1, 3, 'Servicios de Cloud Computing', '300.00', '{"CABL": 4, "FIBR": 10}', 1),
(1, 3, 'Asesoría en Tecnología de la Información', '150.00', '{"CABL": 4, "FIBR": 10}', 1),
(1, 3, 'Instalación de Redes Inalámbricas WISP', '200.00', '{"CABL": 4, "FIBR": 10}', 1),
(1, 3, 'Consultoría de Seguridad Informática', '250.00', '{"CABL": 4, "FIBR": 10}', 1),
(3, 1, 'Soluciones de Internet de las Cosas (IoT) Fibra', '300.00', '{"FIBR": 24, "CABL": 12}', 1),
(1, 3, 'Migración a la Nube WISP', '400.00', '{"CABL": 4, "FIBR": 10}', 1),
(3, 1, 'Desarrollo de Sistemas de Gestión Fibra', '500.00', '{"FIBR": 24, "CABL": 12}', 1);
...
(1, 1, 20, 1, NULL, 'Av. Siempre Viva 123, Springfield', 'Cerca de la plaza principal', '12.3456, -65.4321', '2024-01-15', '{"FIBR": 24, "CABL": 12}', '2024-01-01', 'Primer contrato: Servicio WISP Básico con 6 meses de duración'),
(2, 4, 20, 1, NULL, 'Calle Falsa 456, Gotham', 'Cerca del cine local', '34.5678, -76.5432', '2024-02-01', '{"FIBR": 24, "CABL": 12}', '2024-02-01', 'Renovación de contrato: Fibra + Cable por 6 meses'),
(3, 3, 20, 1, NULL, 'Av. Los Pinos 789, Lima', 'Esquina con Av. Las Flores', '23.4567, -54.3210', '2024-03-01', '{"FIBR": 24, "CABL": 12}', '2024-03-01', 'Contrato nuevo: Instalación de Fibra + revisión mensual'),
(4, 4, 20, 1, NULL, 'Jirón de la Unión 100, Lima', 'Frente a la Plaza Mayor', '45.6789, -43.2109', '2024-04-01', '{"FIBR": 24, "CABL": 12}', '2024-04-01', 'Renovación anual: Descuento aplicado por contrato anual'),
(5, 5, 20, 1, NULL, 'Calle Mayor 101, Barcelona', 'Cerca del mercado central', '56.7890, -32.1098', '2024-05-01', '{"FIBR": 24, "CABL": 12}', '2024-05-01', 'Contrato especial por volumen: Servicio completo por 1 año'),
(6, 1, 20, 1, NULL, 'Av. del Libertador 200, Buenos Aires', 'A la vuelta de la oficina', '12.0011, -66.1122', '2024-06-01', '{"FIBR": 24, "CABL": 12}', '2024-06-01', 'Servicio premium incluido en el contrato WISP'),
(7, 2, 20, 1, NULL, 'Calle de la Alegría 333, Bogotá', 'Cerca de la estación de buses', '34.3333, -76.6666', '2024-07-01', '{"FIBR": 24, "CABL": 12}', '2024-07-01', 'Contrato por 6 meses: Soporte técnico 24/7 incluido'),
(8, 3, 20, 1, NULL, 'Paseo del Prado 150, Madrid', 'Cerca del parque del Retiro', '23.8888, -54.7777', '2024-08-01', '{"FIBR": 24, "CABL": 12}', '2024-08-01', 'Contrato semestral: Mantenimiento semestral incluido'),
(9, 4, 20, 1, NULL, 'Av. de la Paz 400, Santiago', 'Frente al hotel Plaza', '45.2222, -43.8888', '2024-09-01', '{"FIBR": 24, "CABL": 12}', '2024-09-01', 'Promoción especial: Contrato de 6 meses con descuento'),
(10, 5, 20, 1, NULL, 'Calle del Comercio 789, Lima', 'Cerca de la Plaza San Martín', '56.4444, -32.5555', '2024-10-01', '{"FIBR": 24, "CABL": 12}', '2024-10-01', 'Contrato especial: Condiciones personalizadas aplicadas'),
(11, 2, 20, 1, NULL, 'Av. Principal 111, Quito', 'Frente al centro comercial', '11.1111, -66.6666', '2024-02-15', '{"FIBR": 24, "CABL": 12}', '2024-02-15', 'Contrato estándar de WISP con soporte adicional'),
(12, 3, 20, 1, NULL, 'Calle Secundaria 222, Caracas', 'Cerca del parque central', '22.2222, -55.5555', '2024-03-10', '{"FIBR": 24, "CABL": 12}', '2024-03-10', 'Contrato de Fibra: Instalación y soporte técnico semestral'),
(13, 4, 20, 1, NULL, 'Av. Terciaria 333, Montevideo', 'Frente al museo histórico', '33.3333, -44.4444', '2024-04-20', '{"FIBR": 24, "CABL": 12}', '2024-04-20', 'Renovación de contrato: Instalación de Fibra con soporte anual'),
(14, 5, 20, 1, NULL, 'Jirón Cuarto 444, Lima', 'Esquina con la calle Pinos', '44.4444, -33.3333', '2024-05-05', '{"FIBR": 24, "CABL": 12}', '2024-05-05', 'Contrato a medida: Servicio de Fibra + descuento corporativo'),
(15, 1, 20, 1, NULL, 'Calle Final 555, La Paz', 'Cerca del edificio principal', '55.5555, -22.2222', '2024-06-01', '{"FIBR": 24, "CABL": 12}', '2024-06-01', 'Contrato nuevo: Servicio WISP básico con soporte trimestral'),
(16, 1, 20, 1, NULL, 'Calle Estrella 111, Lima', 'Cerca de la Plaza de Armas', '55.5555, -22.2222', '2024-07-01', '{"FIBR": 24, "CABL": 12}', '2024-07-01', 'Contrato: Servicio WISP básico con soporte técnico mensual'),
(17, 2, 20, 1, NULL, 'Calle Estrella 222, Lima', 'Cerca del Parque Kennedy', '44.4444, -33.3333', '2024-08-01', '{"FIBR": 24, "CABL": 12}', '2024-08-01', 'Contrato: Servicio Cable estándar con revisión mensual'),
(18, 3, 20, 1, NULL, 'Calle Estrella 333, Lima', 'Cerca del Parque Universitario', '33.3333, -44.4444', '2024-09-01', '{"FIBR": 24, "CABL": 12}', '2024-09-01', 'Contrato: Instalación de Fibra con soporte semestral'),
(19, 4, 20, 1, NULL, 'Calle Estrella 444, Lima', 'Cerca del Centro Comercial', '22.2222, -55.5555', '2024-10-01', '{"FIBR": 24, "CABL": 12}', '2024-10-01', 'Contrato: Mantenimiento de Fibra con soporte anual'),
(20, 5, 20, 1, NULL, 'Calle Estrella 555, Lima', 'Cerca del Aeropuerto', '11.1111, -66.6666', '2024-11-01', '{"FIBR": 24, "CABL": 12}', '2024-11-01', 'Contrato: Servicio especial por volumen, 12 meses');
